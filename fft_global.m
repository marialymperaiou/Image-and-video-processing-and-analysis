...
%στον παρακάτω κωδικα διατηρήθηκαν σε σχόλια οι ενδιάμεσες εικόνες όπως
%δίνονταν από τον κώδικα των διαφανειών
...
% RGB->YCBCR
YCbCr = (rgb2ycbcr(RGB));
Y = YCbCr(:,:,1);   %εκχωρώ κάθε συνιστώσα σε μια στήλη
Cb = YCbCr(:,:,2);
Cr = YCbCr(:,:,3);
