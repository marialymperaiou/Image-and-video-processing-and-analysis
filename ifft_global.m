...
iRGB = ycbcr2rgb(iYCbCr);                           %Μετατροπή χρωματικού χώρου(από YCbCr σε RGB)
figure,imshow(iRGB),title('global-FFT image');      %Απεικόνιση έγχρωμης ανακατασκευασμένης εικόνας (iRGB)
